...
// void turnGyroLeft(int tdistance, int tspeed, int twait) {
//     vex::task::sleep(twait); 
//     lb.resetRotation();
//     vex::task::sleep(150); 

//     while (abs(Gyro.value(vex::rotationUnits::deg)) < tdistance)
//     {
//         lf.spin(vex::directionType::fwd,-tspeed,vex::velocityUnits::rpm);
//         lb.spin(vex::directionType::fwd,-tspeed,vex::velocityUnits::rpm);
//         rf.spin(vex::directionType::fwd,tspeed,vex::velocityUnits::rpm);
...
void armUp() {
        arm.rotateFor(0.21, rotationUnits::rev, 100, velocityUnits::rpm);
        arm.stop(brakeType::hold);
}

void armDown() {
        arm.rotateFor(-0.23, rotationUnits::rev, 100, velocityUnits::rpm);
        arm.stop(brakeType::hold);
}

void armUpPlat() {
        arm.rotateFor(0.14, rotationUnits::rev, 200, velocityUnits::rpm);
        arm.stop(brakeType::hold);
}
...
int main(void) {
    ...
    arm.rotateFor(0.21, rotationUnits::rev, 25, velocityUnits::rpm);
    arm.stop(brakeType::hold);
